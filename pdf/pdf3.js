...
function getSelectedSpan() {
    ...
    while (currentElement.nextSibling != LastDad) {
        ...
        for (var i = 0; i < currentElement.childNodes.length; i++) {
            if (currentElement.childNodes[i].nodeName === 'SPAN' 
                && !currentElement.childNodes[i].classList.contains(highlightCls)) {
                ...
                // console.log("2:", currentElement.childNodes[i])
                currentElement.childNodes[i].appendChild(newSpan);
                // console.log("3:", currentElement.childNodes[i])
            }
        }
    ...
    for (var i = 0; i < LastDad.childNodes.length; i++) {
        if (LastDad.childNodes[i].nodeName === 'SPAN' 
            && !LastDad.childNodes[i].classList.contains(highlightCls)) {
            var newSpan = document.createElement('span');
            newSpan.classList.add('highlight');
